...
@Suite(.timeLimit(.minutes(5))) struct OracleJSONDecoderTests {
    ...
    @Suite(.timeLimit(.minutes(5))) struct KeyedDecodingContainerTests {
    ...
    @Suite(.timeLimit(.minutes(5))) struct UnkeyedDecodingContainerTests {
        @Test func decodeNull() throws {
            let decoder = _OracleJSONDecoder(
                codingPath: [],
                userInfo: [:],

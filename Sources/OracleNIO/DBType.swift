...
struct DBType {
    ...
    static let supported = [
        ...
        DBType(number: .binaryInteger, name: "DB_TYPE_BINARY_INTEGER", oracleName: "BINARY_INTEGER", oracleType: .init(rawValue: 3)!, bufferSizeFactor: 22),
        DBType(number: .blob, name: "DB_TYPE_BLOB", oracleName: "BLOB", oracleType: .init(rawValue: 113)!, bufferSizeFactor: 112),
        DBType(number: .boolean, name: "DB_TYPE_BOOLEAN", oracleName: "BOOLEAN", oracleType: .init(rawValue: 252)!, bufferSizeFactor: 4),
        ...
        DBType(number: .clob, name: "DB_TYPE_CLOB", oracleName: "CLOB", oracleType: .init(rawValue: 112)!, csfrm: 1, bufferSizeFactor: 112),
        DBType(number: .cursor, name: "DB_TYPE_CURSOR", oracleName: "CURSOR", oracleType: .init(rawValue: 102)!, bufferSizeFactor: 4),
        DBType(number: .date, name: "DB_TYPE_DATE", oracleName: "DATE", oracleType: .init(rawValue: 12)!, bufferSizeFactor: 7),
        DBType(number: .intervalDS, name: "DB_TYPE_INTERVAL_DS", oracleName: "INTERVAL DAY TO SECOND", oracleType: .init(rawValue: 183)!, bufferSizeFactor: 11),
        ...
        DBType(number: .nCLOB, name: "DB_TYPE_NCLOB", oracleName: "NCLOB", oracleType: .init(rawValue: 112)!, csfrm: 2, bufferSizeFactor: 112),
        DBType(number: .number, name: "DB_TYPE_NUMBER", oracleName: "NUMBER", oracleType: .init(rawValue: 2)!, bufferSizeFactor: 22),
        ...
        DBType(number: .object, name: "DB_TYPE_OBJECT", oracleName: "OBJECT", oracleType: .init(rawValue: 109)!),
           DBType(number: .raw, name: "DB_TYPE_RAW", oracleName: "RAW", oracleType: .init(rawValue: 23)!, defaultSize: 4000, bufferSizeFactor: 1),
        ...
        DBType(number: .varchar, name: "DB_TYPE_VARCHAR", oracleName: "VARCHAR2", oracleType: .init(rawValue: 1)!, defaultSize: 4000, csfrm: 1, bufferSizeFactor: 4)
    ]
}
